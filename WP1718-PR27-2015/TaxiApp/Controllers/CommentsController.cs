...
namespace TaxiApp.Controllers
{
    ...
    public class CommentsController : ApiController
    {
        ...
        //[Route("post")]
        [ResponseType(typeof(Comment))]
        public IHttpActionResult PostComment(string senderID, [FromBody]Comment comment)
        {
            return Ok();
        ...
        #region PUT
        [HttpPut]
        [Route("api/comments/put")]
        //[Route("put")]
        [ResponseType(typeof(Comment))]
        // PUT api/drivers/5
        public IHttpActionResult PutComment(string senderID, [FromBody]Comment comment)
        {
            return Ok();
            //AdminDbAccess dbAdmin = AdminDbAccess.Instance;
            //DriverDbAccess dbDriver = DriverDbAccess.Instance;
        ...
        public IHttpActionResult DeleteComment(string senderID, [FromBody]string commentToDelete)
        {
            return Ok();
            //AdminDbAccess dbAdmin = AdminDbAccess.Instance;
            //DriverDbAccess dbDriver = DriverDbAccess.Instance;
